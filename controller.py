...
from model import Categorias, Fornecerdores
...
if __name__ == '__main__':
    resposta = FornecedoresController.cadastrar(
        '12345678901234', 'Fornecedor 2', '12345678901', 'Categoria 2')
    print('ok' if resposta else 'erro')
    input()
    print(FornecedoresController.buscar(nome='Fornecedor 1'))
    print(FornecedoresController.buscar(id=1))
    print(FornecedoresController.buscar())
